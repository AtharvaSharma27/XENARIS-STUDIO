    ...
    <section id="about" className="py-24 px-6 md:px-12 border-t border-white/10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-lg text-[var(--color-text-muted)] max-w-4xl">
            <p>
        ...
        >
          <p className="text-sm text-center text-white/40 uppercase tracking-widest mb-8">Trusted by</p>
